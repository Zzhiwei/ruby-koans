...
class AboutMethods < Neo::Koan
  ...
  def method_with_defaults(a, b=:default_value)
    # it seems the final value written is the return value ???
    [a, b]
  end
  ...
  def test_calling_with_variable_arguments
    ...
    assert_equal [], method_with_var_args   # this looks a bit confusing, initial thought that it is a function but rmb function without brackets is a call too
