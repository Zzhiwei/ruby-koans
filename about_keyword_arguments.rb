...
class AboutKeywordArguments < Neo::Koan
  ...
  def method_with_keyword_arguments(one: 1, two: 'two') # normal arg default is using "=", keyword arg default is ":"
    [one, two]
  end

  def test_keyword_arguments
    # very confusing, thought it is attribute of the function object, but it is attr of return value
